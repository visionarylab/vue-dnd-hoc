      ...
      <div class="panel-row">
        ...
        <div class="panel-value">
          <input
            ...
            :placeholder="getPlaceholderName('duration')"
            type="text">
        </div>
      </div>
      ...
      <div class="panel-row">
        ...
        <div class="panel-value">
          <input
            ...
            :placeholder="getPlaceholderName('delay')"
            type="text">
        </div>
      </div>
      ...
      <div class="panel-row">
        ...
        <div class="panel-value">
          <input
            ...
            :placeholder="getPlaceholderName('iteration')"
            type="text">
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    getPlaceholderName (name) {
      return this.$t('data.animations.placeholders.' + name)
    }
  }
}
</script>
